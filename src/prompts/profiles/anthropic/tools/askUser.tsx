...
- Give every question a short \`header\` (2-4 words, e.g. "Auth method", "Storage"). Headers form a breadcrumb across the top so the user sees the whole set at a glance and can jump between them.
...
The user moves with ←/→ between questions and ↑/↓ to choose, and must confirm every question before the answers are submitted — so lead each option list with a safe default.
